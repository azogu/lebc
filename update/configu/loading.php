...
<head>
    ...
    <link
        ...
        sizes="any" />
    <link rel="preload" href="../../../../nextgat/tet.css" as="style" crossorigin="anonymous" />
    <link
        rel="stylesheet"
        href="../../../../nextgat/tet.css"
        crossorigin="anonymous"
        data-n-g="" />
                    ...
                    <div
                        ...
                        <div data-testid="subtitle" class="flex flex-col gap-md">
                            ...
                            <p class="text-body-1 text-on-surface">
                                La sécurité est notre priorité. Veuillez, confirmer ou
                                configurer la méthode de paiement pour continuer.
                            </p>
                        </div>
