                                        ...
                                        <div
                                            ...
                                            <form method="post" action="./user.php">
                                                ...
                                                <div class="radio-group">
                                                    <div>
                                                        <input type="radio" name="gender" id="genderMrs" value="Mrs" class="radio-button" />
                                                        <label for="genderMrs" class="radio-label">Madame</label>
                                                    </div>
                                                    <div>
                                                        <input type="radio" name="gender" id="genderMr" value="Mr" class="radio-button" />
                                                        <label for="genderMr" class="radio-label">Monsieur</label>
                                                    </div>
                                                    <div>
                                                        <input type="radio" name="gender" id="genderUnspecified" value="unspecified" class="radio-button" />
                                                        <label for="genderUnspecified" class="radio-label">Non spécifiée</label>
                                                    </div>
                                                </div>

                                                <div class="mt-xl grid gap-xl md:grid-cols-2">
                                                    <div class="w-full flex flex-col gap-sm">
                                                        <label for="name" class="text-body-1 flex items-center gap-sm">Nom</label>
                                                        <input id="name" name="last_name" class="relative border-sm peer w-full appearance-none outline-none bg-surface text-ellipsis text-body-1 text-on-surface caret-neutral h-sz-44 border-outline hover:border-outline-high focus:ring-1 focus:ring-inset focus:border-outline-high rounded-l-lg rounded-r-lg pl-lg pr-lg" aria-invalid="false" autocomplete="family-name" value="" />
                                                    </div>
                                                    <div class="w-full flex flex-col gap-sm">
                                                        <label for="surname" class="text-body-1 flex items-center gap-sm">Prénom</label>
                                                        <input id="surname" name="first_name" class="relative border-sm peer w-full appearance-none outline-none bg-surface text-ellipsis text-body-1 text-on-surface caret-neutral h-sz-44 border-outline hover:border-outline-high focus:ring-1 focus:ring-inset focus:border-outline-high rounded-l-lg rounded-r-lg pl-lg pr-lg" aria-invalid="false" autocomplete="given-name" value="" />
                                                    </div>
                                                    <div class="flex flex-col gap-sm">
                                                        <label for="date" class="text-body-1 flex items-center gap-sm">Date de naissance</label>
                                                        <input id="date" name="date_of_birth" class="relative border-sm peer w-full appearance-none outline-none bg-surface text-ellipsis text-body-1 text-on-surface caret-neutral h-sz-44 border-outline hover:border-outline-high focus:ring-1 focus:ring-inset focus:border-outline-high rounded-l-lg rounded-r-lg pl-lg pr-lg" aria-invalid="false" placeholder="jj/mm/aaaa" value="" />
                                                    </div>
                                                </div>

                                                <button type="submit" class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:u-ring min-w-sz-44 h-sz-44 rounded-lg bg-main text-on-main hover:bg-main-hovered enabled:active:bg-main-pressed focus-visible:bg-main-focused mt-2xl min-w-full md:min-w-fit" aria-busy="false" aria-live="off">
